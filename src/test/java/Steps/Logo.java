...
public class Logo extends BaseUtil {
    ...
    public void cliquerSurLaZoneLatéraleLogoDeLaRubriqueApprance() throws Throwable {
        Thread.sleep(8000);
    ...
    public void jAiChoisiUnFichierDeTypeDifférentDImage() throws Throwable {
    ...
    public void leMessageÉchecErrorOccuredDuringUploadOfNewContentSAfficheDansLePopup() throws Throwable {
        base.Driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
    ...
    @And("^je déconnecte$")
    public void jeDéconnecte() throws Throwable {
